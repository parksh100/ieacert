<template>
  <div class="container">
    ...
    <div class="row mb-3">
      ...
      <div class="col-sm-10">
        <button class="btn btn-danger me-2" @click="$refs.file.click()">
          이미지 업로드
        </button>
        <input
          type="file"
    ...
    <div class="row mb-3">
      <label class="col-sm-2 col-form-label">Photo Detail</label>
      <div class="col-sm-10">
        <button class="btn btn-danger me-2" @click="$refs.file2.click()">
          이미지 업로드
        </button>
        <input
          type="file"
        ...
        />
        <img :src="imgSrc2" alt="" style="width: 200px; height: auto" />
      </div>
    </div>
